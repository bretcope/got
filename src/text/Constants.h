#ifndef MOT_CONSTANTS_H
#define MOT_CONSTANTS_H
...
namespace mot
{
    namespace Constants
    {
        extern const MotString ALIAS;
        extern const MotString CONFIG;
        extern const MotString DEFAULT;
        extern const MotString ENV;
